...
NOTA SOBRE SEMBRADO/POSICIONES:
NO incluyas coordenadas de posición ("positions") en la propuesta. Solo genera las áreas con sus equipos y cantidades.
El posicionamiento en plano se hace en un paso separado después.
...
IMPORTANTE: NO incluyas el campo "positions" en los items. Solo áreas, equipos y cantidades.
