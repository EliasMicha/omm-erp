...
import { LayoutDashboard, FileText, ClipboardList, Users, Truck, FolderOpen, Users2, BookOpen, ShoppingCart, TrendingUp, Building2, Package, Receipt, BrainCircuit, ChevronLeft, ChevronRight, Menu, X, LogOut, Shield, Wrench, Archive, Gauge, FolderArchive, ListChecks, GraduationCap, UserPlus, MessageCircle } from 'lucide-react'
...
const NAV: NavItem[] = [
  ...
  { to: '/documentacion', icon: FolderArchive, label: 'Documentacion' },
  { to: '/desempeno', icon: Gauge, label: 'Desempeno' },
  { to: '/capacitaciones', icon: GraduationCap, label: 'Capacitaciones' },
  { to: '/reclutamiento', icon: UserPlus, label: 'Reclutamiento', allowedAreas: ['Administracion'] },
  ...
  { to: '/integraciones/whatsapp', icon: MessageCircle, label: 'WhatsApp Business', allowedAreas: [] as PermissionArea[] },
]
