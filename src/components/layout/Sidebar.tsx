...
import { LayoutDashboard, FileText, ClipboardList, Users, Truck, FolderOpen, Users2, BookOpen, ShoppingCart, TrendingUp, Building2, Package, Receipt, BrainCircuit, ChevronLeft, ChevronRight, Menu, X, LogOut, Shield, Wrench, Archive, Gauge, FolderArchive, ListChecks, GraduationCap, UserPlus, Inbox } from 'lucide-react'
...
const NAV: NavItem[] = [
  ...
  { to: '/mi-trabajo', icon: Inbox, label: 'Mi trabajo (beta)' },
