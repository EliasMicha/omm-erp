            ...
            {/* Logo */}
                  <div style={{ padding: '20px 16px 16px', borderBottom: '1px solid #222' }}>
                            <div style={{ fontSize: 16, fontWeight: 700, color: '#fff', letterSpacing: '-0.02em' }}>
                                        <span style={{ color: '#57FF9A' }}>OMM</span>span> Tech
                            </div>div>
                            <div style={{ fontSize: 10, color: '#555', marginTop: 2, letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                                        ERP Sistema
                            </div>div>
                  </div>div>
...
import { LayoutDashboard, FileText, ClipboardList, Users, Truck, FolderOpen, ChevronRight } from 'lucide-react'
